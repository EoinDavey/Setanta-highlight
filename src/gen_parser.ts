        ...
        return this.runner<Program>($$dpth,
            (log) => {
                ...
                if (true
                    ...
                    && (ws = this.match_($$dpth + 1, cr)) !== null
                ) {
                    res = {kind: ASTKinds.Program, stmts, ws};
                }
                return res;
            }, cr)();
    }
        ...
        return this.runner<IfStmt>($$dpth,
            (log) => {
                ...
                if (true
                    ...
                    res = {kind: ASTKinds.IfStmt, ws, expr, stmt, elsebranch};
                }
                return res;
            }, cr)();
    }
        ...
        return this.runner<IfStmt_$0>($$dpth,
            (log) => {
                ...
                if (true
                    ...
                    res = {kind: ASTKinds.IfStmt_$0, ws, stmt};
                }
                return res;
            }, cr)();
    }
    public matchBlockStmt($$dpth: number, cr?: ContextRecorder): Nullable<BlockStmt> {
        return this.runner<BlockStmt>($$dpth,
            (log) => {
                ...
                if (true
                    && (wsa = this.match_($$dpth + 1, cr)) !== null
                    && this.regexAccept(String.raw`{`, $$dpth + 1, cr) !== null
                    && (blk = this.loop<AsgnStmt>(() => this.matchAsgnStmt($$dpth + 1, cr), true)) !== null
                    && (wsb = this.match_($$dpth + 1, cr)) !== null
                    && this.regexAccept(String.raw`}`, $$dpth + 1, cr) !== null
                ) {
                    res = {kind: ASTKinds.BlockStmt, wsa, blk, wsb};
                }
                return res;
            }, cr)();
    }
        ...
        return this.runner<NuairStmt>($$dpth,
            (log) => {
                ...
                if (true
                    ...
                    res = {kind: ASTKinds.NuairStmt, ws, expr, stmt};
                }
                return res;
            }, cr)();
    }
        ...
        return this.runner<LeStmt>($$dpth,
            (log) => {
                ...
                if (true
                    ...
                    && (wsc = this.match_($$dpth + 1, cr)) !== null
                    && this.regexAccept(String.raw`\(`, $$dpth + 1, cr) !== null
                    && (strt = this.matchExpr($$dpth + 1, cr)) !== null
                    && (wsd = this.match_($$dpth + 1, cr)) !== null
                    && this.regexAccept(String.raw`,`, $$dpth + 1, cr) !== null
                    && (end = this.matchExpr($$dpth + 1, cr)) !== null
                    && ((step = this.matchLeStmt_$0($$dpth + 1, cr)) || true)
                    && (wse = this.match_($$dpth + 1, cr)) !== null
                    && this.regexAccept(String.raw`\)`, $$dpth + 1, cr) !== null
                    && (stmt = this.matchNonAsgnStmt($$dpth + 1, cr)) !== null
                ) {
                    res = {kind: ASTKinds.LeStmt, wsa, id, wsb, wsc, strt, wsd, end, step, wse, stmt};
                }
                return res;
            }, cr)();
    }
        ...
        return this.runner<LeStmt_$0>($$dpth,
            (log) => {
                ...
                if (true
                    ...
                    res = {kind: ASTKinds.LeStmt_$0, ws, step};
                }
                return res;
            }, cr)();
    }
        ...
        return this.runner<DefnStmt>($$dpth,
            (log) => {
                ...
                if (true
                    ...
                    res = {kind: ASTKinds.DefnStmt, wsa, id, wsb, wsc, expr};
                }
                return res;
            }, cr)();
    }
        ...
        return this.runner<AssgnStmt>($$dpth,
            (log) => {
                ...
                if (true
                    ...
                    res = {kind: ASTKinds.AssgnStmt, wsa, lhs, wsb, op, wsc, expr};
                }
                return res;
            }, cr)();
    }
        ...
        return this.runner<GniomhStmt>($$dpth,
            (log) => {
                ...
                if (true
                    ...
                    res = {kind: ASTKinds.GniomhStmt, wsa, id, wsb, args, wsc, wsd, stmts, wse};
                }
                return res;
            }, cr)();
    }
        ...
        return this.runner<CtlchStmt>($$dpth,
            (log) => {
                ...
                if (true
                    ...
                    res = {kind: ASTKinds.CtlchStmt, wsa, id, tuis, wsb, gniomhs, wsc};
                }
                return res;
            }, cr)();
    }
        ...
        return this.runner<CtlchStmt_$0>($$dpth,
            (log) => {
                ...
                if (true
                    ...
                    res = {kind: ASTKinds.CtlchStmt_$0, wsa, wsb, id};
                }
                return res;
            }, cr)();
    }
        ...
        return this.runner<ToradhStmt>($$dpth,
            (log) => {
                ...
                if (true
                    ...
                    res = {kind: ASTKinds.ToradhStmt, ws, exp};
                }
                return res;
            }, cr)();
    }
        ...
        return this.runner<And_$0>($$dpth,
            (log) => {
                ...
                if (true
                    ...
                    res = {kind: ASTKinds.And_$0, ws, trm};
                }
                return res;
            }, cr)();
    }
        ...
        return this.runner<Or_$0>($$dpth,
            (log) => {
                ...
                if (true
                    ...
                    res = {kind: ASTKinds.Or_$0, ws, trm};
                }
                return res;
            }, cr)();
    }
        ...
        return this.runner<Eq_$0>($$dpth,
            (log) => {
                ...
                if (true
                    ...
                    res = {kind: ASTKinds.Eq_$0, ws, op, trm};
                }
                return res;
            }, cr)();
    }
        ...
        return this.runner<Comp_$0>($$dpth,
            (log) => {
                ...
                if (true
                    ...
                    res = {kind: ASTKinds.Comp_$0, ws, op, trm};
                }
                return res;
            }, cr)();
    }
        ...
        return this.runner<Sum_$0>($$dpth,
            (log) => {
                ...
                if (true
                    ...
                    res = {kind: ASTKinds.Sum_$0, ws, op, trm};
                }
                return res;
            }, cr)();
    }
        ...
        return this.runner<Product_$0>($$dpth,
            (log) => {
                ...
                if (true
                    ...
                    res = {kind: ASTKinds.Product_$0, ws, op, trm};
                }
                return res;
            }, cr)();
    }
        ...
        return this.runner<Prefix>($$dpth,
            (log) => {
                ...
                if (true
                    ...
                    res = {kind: ASTKinds.Prefix, ws, op, pf};
                }
                return res;
            }, cr)();
    }
        ...
        return this.runner<PostOp_1>($$dpth,
            (log) => {
                ...
                if (true
                    ...
                    res = {kind: ASTKinds.PostOp_1, args, ws};
                }
                return res;
            }, cr)();
    }
        ...
        return this.runner<PostOp_2>($$dpth,
            (log) => {
                ...
                if (true
                    ...
                    res = {kind: ASTKinds.PostOp_2, expr, ws};
                }
                return res;
            }, cr)();
    }
        ...
        return this.runner<Atom_1>($$dpth,
            (log) => {
                ...
                if (true
                    ...
                    res = {kind: ASTKinds.Atom_1, ws, trm};
                }
                return res;
            }, cr)();
    }
        ...
        return this.runner<ListLit>($$dpth,
            (log) => {
                ...
                if (true
                    ...
                    res = {kind: ASTKinds.ListLit, wsa, els, wsb};
                }
                return res;
            }, cr)();
    }
        ...
        return this.runner<CSArgs_$0>($$dpth,
            (log) => {
                ...
                if (true
                    ...
                    res = {kind: ASTKinds.CSArgs_$0, ws, exp};
                }
                return res;
            }, cr)();
    }
        ...
        return this.runner<CSIDs_$0>($$dpth,
            (log) => {
                ...
                if (true
                    ...
                    res = {kind: ASTKinds.CSIDs_$0, ws, id};
                }
                return res;
            }, cr)();
    }
        ...
        return this.runner<Bool>($$dpth,
            (log) => {
                ...
                if (true
                    ...
                    res = {kind: ASTKinds.Bool, ws, bool};
                }
                return res;
            }, cr)();
    }
        ...
        return this.runner<Litreacha>($$dpth,
            (log) => {
                ...
                if (true
                    ...
                    res = {kind: ASTKinds.Litreacha, ws, val};
                }
                return res;
            }, cr)();
    }
    public match_($$dpth: number, cr?: ContextRecorder): Nullable<_> {
        return this.runner<_>($$dpth,
            (log) => {
                ...
                let sp: Nullable<wspace[]>;
                let res: Nullable<_> = null;
                if (true
                    && (sp = this.loop<wspace>(() => this.matchwspace($$dpth + 1, cr), true)) !== null
                ) {
                    res = {kind: ASTKinds._, sp};
                }
                return res;
            }, cr)();
    }
